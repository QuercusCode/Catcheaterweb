...
const articles = [
    {
        ...
        authorTitle: "Co-Founder & Lead Scientist",
    ...
    },
    {
        ...
        authorTitle: "Co-Founder & Research Lead",
            ...
            <main className="container px-6 py-12 mx-auto max-w-7xl">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {articles.map((article) => (
                        <article key={article.id} className="card bg-white border border-border rounded-xl overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group flex flex-col h-full">
                            {/* Image Placeholder */}
                            <div className="relative h-48 w-full border-b border-border overflow-hidden shrink-0">
                                <Image
                                    src={article.image}
                                    alt={article.title}
                                    fill
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                ...
                                <div className="mt-auto pt-4 border-t border-border/50 flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-muted-foreground font-medium">{article.authorTitle}</p>
                                    </div>
                                </div>
                            </div>
                        </article>
