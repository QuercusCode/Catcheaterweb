...
import { ArrowUpRight, CheckCircle2, Download, MoreHorizontal, TrendingUp, Users, Wallet, Zap, FileText } from 'lucide-react';
                    ...
                    <div className="h-64 flex items-end justify-between gap-4 px-2">
                        {(viewMode === 'revenue'
                            ...
                            <div key={i} className="flex-1 flex flex-col justify-end group cursor-pointer">
                                ...
                                {/* Tooltip */}
                                <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute mb-20 ml-[-10px] bg-slate-800 text-white text-[10px] px-2 py-1 rounded pointer-events-none z-10">
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-slate-100">
                            <tr className="hover:bg-slate-50/80 transition-colors cursor-pointer">
                                <td className="px-6 py-4 font-medium text-slate-900">#CK-2025-001</td>
                                <td className="px-6 py-4 text-slate-500">Cambridge, MA</td>
                                <td className="px-6 py-4"><span className="px-2 py-1 bg-emerald-50 text-emerald-600 rounded-full text-xs font-bold">Complete</span></td>
                                <td className="px-6 py-4 font-mono text-slate-700">5.4 g/L</td>
                                <td className="px-6 py-4 text-slate-500">100%</td>
                            </tr>
                            <tr className="hover:bg-slate-50/80 transition-colors cursor-pointer">
                                <td className="px-6 py-4 font-medium text-slate-900">#CK-2025-002</td>
                                <td className="px-6 py-4 text-slate-500">Singapore HQ</td>
                                <td className="px-6 py-4"><span className="px-2 py-1 bg-blue-50 text-blue-600 rounded-full text-xs font-bold">In Progress</span></td>
                            ...
                            <tr className="hover:bg-slate-50/80 transition-colors cursor-pointer">
                                <td className="px-6 py-4 font-medium text-slate-900">#CK-2025-003</td>
                                <td className="px-6 py-4 text-slate-500">Berlin Ops</td>
                                <td className="px-6 py-4"><span className="px-2 py-1 bg-indigo-50 text-indigo-600 rounded-full text-xs font-bold">Optimization</span></td>
                                <td className="px-6 py-4 font-mono text-slate-700">--</td>
